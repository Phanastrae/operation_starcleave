...
public class StarcleaverGolemEntityModel<T extends StarcleaverGolemEntity> extends EntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, -3.25F, -2.0F, 5.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 20.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
        ...
        ModelPartData drill = modelPartData.addChild("drill", ModelPartBuilder.create().uv(0, 14).cuboid(-1.5F, -3.0F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 16.75F, 0.0F, 0.0F, 3.1416F, 0.0F));
        ...
        ModelPartData legs = modelPartData.addChild("legs", ModelPartBuilder.create(), ModelTransform.of(0.0F, 21.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

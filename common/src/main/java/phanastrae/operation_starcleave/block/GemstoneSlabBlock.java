...
public class GemstoneSlabBlock extends SlabBlock {
    public static final MapCodec<GemstoneSlabBlock> CODEC = simpleCodec(GemstoneSlabBlock::new);

    @Override
    public MapCodec<? extends GemstoneSlabBlock> codec() {
        return CODEC;
    }

    public GemstoneSlabBlock(Properties properties) {
        super(properties);
    }

...
public class GemstoneRotatedPillarBlock extends RotatedPillarBlock {
    public static final MapCodec<GemstoneRotatedPillarBlock> CODEC = simpleCodec(GemstoneRotatedPillarBlock::new);

    @Override
    public MapCodec<? extends GemstoneRotatedPillarBlock> codec() {
        return CODEC;
    }

    public GemstoneRotatedPillarBlock(Properties properties) {
        super(properties);
    }
